...
namespace LOG {
    ...
    public:
        Specialized_logger(std::string _name, Console_painter *_cp, FILE *_out = NULL, bool _file_and_console = false,
                           int _name_color = 0) :
                name(_name), console_painter(_cp), out(_out), print_in_both(_file_and_console),
